...
public static ShopSolrHandler handler;
	...
	public synchronized static ShopSolrHandler getInstance(){
		if(handler == null){
			synchronized(ShopSolrHandler.class){
				if(handler == null)
					handler = new ShopSolrHandler();
			}
		}
		return handler;
	}
...
//					QueryResponse response = server.query(params);
	...
	@Override
	public boolean addBean(S_ShopBean bean){
		try {
			server.addBean(bean);
			server.commit();
			return true;
	...
	@Override
	public boolean addBeans(List<S_ShopBean> beans){
		try {
	...
	@Override
	public boolean updateBean(S_ShopBean bean) {
		return addBean(bean);
	}

	@Override
	public boolean updateBeans(List<S_ShopBean> beans) {
