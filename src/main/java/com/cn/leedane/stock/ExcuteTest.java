...
public class ExcuteTest {
	...
	private final static int START_CALCULATE_NPER = 1;  //开始计算的期数,将从此位置开始计算
	private final static int CURRENT_CALCULATE_NPER = 4;  //即将开奖的期数
	private final static int COMBIE_DEPP = 3; //计算组合的时候的深度，必须大于1的整数
	private final static int EACH_DOWN_DEPP = 1;//每次将组合向下最大的移动数量
	...
	static{
		...
		numbers.add(3);numbers.add(4);numbers.add(1);numbers.add(3);numbers.add(6);numbers.add(5);numbers.add(2);
		allStocks.add(new QXStock(1, numbers));
		numbers = new ArrayList<Integer>();
		
		numbers.add(5);numbers.add(2);numbers.add(3);numbers.add(5);numbers.add(0);numbers.add(3);numbers.add(3);
		allStocks.add(new QXStock(2, numbers));
		numbers = new ArrayList<Integer>();
		
		numbers.add(2);numbers.add(0);numbers.add(4);numbers.add(6);numbers.add(2);numbers.add(1);numbers.add(2);
		allStocks.add(new QXStock(3, numbers));
		numbers = new ArrayList<Integer>();
		
		/*numbers.add(2);numbers.add(1);numbers.add(1);numbers.add(2);numbers.add(4);numbers.add(0);numbers.add(3);
		allStocks.add(new QXStock(4, numbers));
		numbers = new ArrayList<Integer>();*/
		
		/*numbers.add(0);numbers.add(1);numbers.add(1);numbers.add(6);numbers.add(4);numbers.add(6);numbers.add(6);
		allStocks.add(new QXStock(5, numbers));
		numbers = new ArrayList<Integer>();*/
