...
/**
 * 管理所有的controller访问的根目录的简称
 * @author LeeDane
 * 2017年3月28日 下午4:48:26
 * version 1.0
 */
public class ControllerBaseNameUtil {

	private ControllerBaseNameUtil(){
	 ...
	 * 记账分类
	 */
	public static final String fnc = "fn/category/";
	 ...
	 * 管理员->欢迎页面
	 */
	public static final String adwc = "ad/wc";
