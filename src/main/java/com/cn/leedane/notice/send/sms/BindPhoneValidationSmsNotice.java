 ...
 * Version 1.0
 */
public class BindPhoneValidationSmsNotice extends BaseSmsNotice {
    private Logger logger = Logger.getLogger(getClass());

    public BindPhoneValidationSmsNotice(SMS sms) throws NoticeException {
        super(sms, "LeeDane", "SMS_181195996");
    }
    ...
    public String getKey() throws NoticeException {
        return BIND_PHONE_KEY_PREFIX + getMobilePhone();
    }
    ...
    public boolean send() throws NoticeException {
        ...
        logger.info(sendAliDaYu("{\"code\":\""+validationCode+"\"}"));
        return true;
    }
}
