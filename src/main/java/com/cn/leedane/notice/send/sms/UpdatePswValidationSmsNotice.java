 ...
 * Version 1.0
 */
public class UpdatePswValidationSmsNotice extends BaseSmsNotice {
    private Logger logger = Logger.getLogger(getClass());

    public UpdatePswValidationSmsNotice(SMS sms) throws NoticeException {
        super(sms, "变更验证", "SMS_4961016");
    }
    ...
    public String getKey() throws NoticeException {
        return UPDATE_PSW_KEY_PREFIX + getMobilePhone();
    }
