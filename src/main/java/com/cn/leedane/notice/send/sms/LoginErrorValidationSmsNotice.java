 ...
 * Version 1.0
 */
public class LoginErrorValidationSmsNotice extends BaseSmsNotice {
    private Logger logger = Logger.getLogger(getClass());

    public LoginErrorValidationSmsNotice(SMS sms) throws NoticeException {
        super(sms,"登录验证", "SMS_4961019");
    }
    ...
    public String getKey() throws NoticeException {
        return LOGIN_ERROR_KEY_PREFIX + getMobilePhone();
    }
