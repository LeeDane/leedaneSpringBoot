 ...
 * Version 1.0
 */
public class RegisterValidationSmsNotice extends BaseSmsNotice {
    private Logger logger = Logger.getLogger(getClass());

    public RegisterValidationSmsNotice(SMS sms) throws NoticeException {
        super(sms, "注册验证", "SMS_4961018");
    }
    ...
    public String getKey() throws NoticeException {
        return REGISTER_KEY_PREFIX + getMobilePhone();
    }
