...
public class JobManageController extends BaseController{
	...
	public Map<String, Object> add(HttpServletRequest request) throws SchedulerException{
	...
	public Map<String, Object> update(HttpServletRequest request) throws SchedulerException{
		ResponseMap message = new ResponseMap();
		if(!checkParams(message, request))
			return message.getMap();
	...
	public Map<String, Object> delete(@PathVariable("jid") int jid, HttpServletRequest request) throws SchedulerException{
		ResponseMap message = new ResponseMap();
		if(!checkParams(message, request))
			return message.getMap();
	...
	public Map<String, Object> deletes(HttpServletRequest request, @Param("jobids") String jobids) throws SchedulerException{
		ResponseMap message = new ResponseMap();
		if(!checkParams(message, request))
			return message.getMap();
