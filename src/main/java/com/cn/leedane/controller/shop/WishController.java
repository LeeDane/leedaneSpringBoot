...
public class WishController extends BaseController{
	 ...
	 * @return
	 */
	@RequestMapping(value = "/product/{productId}/wish", method = RequestMethod.POST, produces = {"application/json;charset=UTF-8"})
	public Map<String, Object> add(@PathVariable("productId") int productId, HttpServletRequest request){
		ResponseMap message = new ResponseMap();
		if(!checkParams(message, request))
			return message.getMap();
		
		checkRoleOrPermission(request);
		message.putAll(wishService.add(productId, getUserFromMessage(message), request));
		return message.getMap();
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/wishNumber", method = RequestMethod.GET, produces = {"application/json;charset=UTF-8"})
	 ...
	 * @return
	 */
	@RequestMapping(value = "/mywish", method = RequestMethod.GET, produces = {"application/json;charset=UTF-8"})
