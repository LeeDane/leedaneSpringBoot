...
@Controller
@RequestMapping("/leedane/notification")
public class NotificationController extends BaseController{
	...
	public String sendBroadcast(HttpServletRequest request, HttpServletResponse response){
	 ...
	 * @return
	 */
	@RequestMapping("/sendPrivateChat")
	public String sendPrivateChat(HttpServletRequest request, HttpServletResponse response){
		Map<String, Object> message = new HashMap<String, Object>();
		long start = System.currentTimeMillis();
		try {
			if(!checkParams(message, request)){
