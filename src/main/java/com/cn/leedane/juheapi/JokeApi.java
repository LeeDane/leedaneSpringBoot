...
public class JokeApi {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="8186be199addc02a92b9cbd67f27f694";
    ...
    public static JSONArray getRequest() throws JuHeException {
        ...
        if(object.getInt("error_code")==0){
            return object.optJSONObject("result").optJSONArray("data");
        }else{
            throw new JuHeException(object.get("error_code")+":"+object.get("reason"));
        }
    }
    /*public static void main(String[] args) throws JuHeException {
        getRequest2();
    }*/
