 ...
 * version 1.0
 */
@Component("mallJingdongOrderDetail")
public class MallJingdongOrderDetail extends AbstractScheduling{
	private static Logger logger = Logger.getLogger(MallJingdongOrderDetail.class);
